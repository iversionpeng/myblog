    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 刘star</span>' +
            '</div>');
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="http://lp-myblog.oss-cn-beijing.aliyuncs.com/static/img/mmqrcode1556362726911.png">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信号：abc1362012107</p>' +
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="http://www.firstcode.xyz:8088/article/' + data.articleId  + '"  data-title="' + data.articleTitle + '">' +
