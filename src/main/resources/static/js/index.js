    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2019年04月28日00点';

    //网站开始时间
    var siteBeginRunningTime = '2019-04-28 00:00:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","http://lp-myblog.oss-cn-beijing.aliyuncs.com/static/img/qrcode_1556362752257.jpg");
        $('.weixin_code').attr("src","http://lp-myblog.oss-cn-beijing.aliyuncs.com/static/img/mmqrcode1556362726911.png");
    });
