...
public class UserServiceImpl implements UserService {
    ...
    public String insert(User user) {
        ...
        if("male".equals(user.getGender())){
            user.setAvatarImgUrl("http://lp-myblog.oss-cn-beijing.aliyuncs.com/static/img/noLogin_male.jpg");
        } else {
            user.setAvatarImgUrl("http://lp-myblog.oss-cn-beijing.aliyuncs.com/static/img/noLogin_female.jpg");
        }
